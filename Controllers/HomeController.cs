...
using BasicWebServer.Attributes;
...
namespace BasicWebServer.Demo.Controllers
{
    public class HomeController:Controller
    {
        ...
        {
            var requestHasCookies = Request.Cookies.Any(c => c.Name != BasicWebServer.HTTP.Session.SessionCookieName);
            var bodyText = "";
        ...
        public Response Session()
        {
            var sessionExists = Request.Session
                .ContainsKey(BasicWebServer.HTTP.Session.SessionCurrentDateKey);

            var bodyText = "";

            if (sessionExists)
            {
                var currentDate = Request.Session[BasicWebServer.HTTP.Session.SessionCurrentDateKey];
